...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
		<div class="container">
			...
			<a class="navbar-brand" href="#">S.I Pendataan Penduduk</a>
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<!-- <a class="dropdown-item" href="desa.php">Data Desa</a> -->
							...
							<a class="dropdown-item" href="#">Data Penduduk Pindah & Datang</a>
							<a class="dropdown-item" href="#">Data Pembuatan KK</a>
							<a class="dropdown-item" href="#">Data Permohonan e-KTP</a>
						</div>
					</li>
					<li class="nav-item">
